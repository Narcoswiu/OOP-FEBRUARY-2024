...
namespace HighwayToPeak.Core
{
    public class Controller : IController
    {
        ...
        public string AttackPeak(string climberName, string peakName)
        {
            ...
            {
                return string.Format(OutputMessages.NotSuccessfullAttack, climberName, peakName);
            }
        ...
        public string OverallStatistics()
        {
            ...
            foreach (var climber in climbers.All.OrderByDescending(f=>f.ConqueredPeaks.Count).ThenBy(c=> c.Name))
            {
